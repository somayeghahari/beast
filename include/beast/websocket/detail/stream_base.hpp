...
#include <beast/websocket/detail/zistream.hpp>
#include <beast/websocket/detail/zostream.hpp>
...
enum class pmd_mode : std::uint8_t
{
    decline,
    accept,
    largest,
...
protected:
    ...
    struct pmd_info
    {
        ...
        pmd_mode server_bits_mode = pmd_mode::accept;
        std::uint8_t server_bits = 15;

        bool client_nct = false;
        pmd_mode client_bits_mode = pmd_mode::accept;
    ...
    std::size_t
        wr_frag_size_ = 16 * 1024 * 1024;      // size of auto-fragments
